...
public final class InputField: UIView {
    ...
    public var delegate: InputDelegate? = nil
...
extension InputField {
    ...
    public func setMaxCount(_ maxCount: Int?) {
    ...
    public func updateValidity(_ validity: Validity) {
        self.validitySubject.send(validity)
    }

    public func updateKeyboardType(_ keyboardType: UIKeyboardType) {
...
extension InputField: UITextFieldDelegate {
    public func textField(
        ...
        if let delegate, delegate.textField(textField, shouldChangeCharactersIn: range, replacementString: string) == false {
            return false
        }
